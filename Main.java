...
public class Main extends Application {
    ...
    public void start(Stage window) {
        ...
        if (bank.getNumAccounts() == 0) {
            // only add defaults if no save file exists
            bank.addBankAccount("10001", "11111", 100);
            bank.addBankAccount("10002", "22222", 50);
            bank.addStudentAccount(200, "10003", "33333", 150);
            bank.addPrimeAccount(-200, "10004", "44444", 150);
            bank.addSavingsAccount(0.05, "10005", "55555", 200);
        }
